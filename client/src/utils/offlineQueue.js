/**
 * Offline queue: store failed API actions in IndexedDB and replay when back online.
 * Used for backup/sync — when offline, actions are queued; when online, they sync to the server.
 */

const DB_NAME = 'supaclean-offline';
