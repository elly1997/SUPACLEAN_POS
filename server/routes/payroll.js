  ...
  try {
    ...
    await db.run(
      `UPDATE employees SET
         ...
         default_allowances = COALESCE($7, default_allowances),
         default_bonuses = COALESCE($8, default_bonuses),
         default_other_deductions = COALESCE($9, default_other_deductions),
         nssf_enabled = COALESCE($10, nssf_enabled),
         nssf_employee_rate = COALESCE($11, nssf_employee_rate),
         nssf_employer_rate = COALESCE($12, nssf_employer_rate),
         paye_enabled = COALESCE($13, paye_enabled),
