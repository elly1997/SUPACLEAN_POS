...
CREATE TABLE "orders" (
        ...
        estimated_collection_date TIMESTAMP, created_at_branch_id INTEGER, ready_at_branch_id INTEGER, collected_at_branch_id INTEGER, branch_id INTEGER,
        FOREIGN KEY (customer_id) REFERENCES customers(id),
...
-- SQLite-specific table removed (not needed in PostgreSQL)
...
-- Index for daily_cash_summaries (branch + date lookups)
